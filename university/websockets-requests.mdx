...
auditChance: number //number, decimal (eg: 20% = 0.20)
finePercent: number //number, decimal (eg: 20% = 0.20)
pcm: number //number, decimal (eg: 1.7) | planet collection multiplier
defaultRate: number //number, decimal (eg: 20% = 0.20)
```
