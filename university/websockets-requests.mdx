...
```javascript
    statusCode: 200,
    body: `{"round":1,"stage":2,"stageStartTime":"19/06/2024, 12:11:11","stageDuration":20}`
```

#### To Players - after stage 1
```javascript
    statusCode: 200,
    body: `{"round":1,"stage":2,"stageStartTime":"19/06/2024, 12:11:11","stageDuration":20,"taxRate":0.15}`
```
...
```javascript
    statusCode: 200,
    body: `{"round":1,"stage":3,"stageStartTime":"19/06/2024, 16:21:12","stageDuration":20,"bankrupt":false,"declared":[800,1100,600,600],"redistributable":3689}`
```

**A Players | Bankrupt**
```javascript
    statusCode: 200,
    body: `{"round":1,"stage":3,"stageStartTime":"19/06/2024, 16:21:12","stageDuration":20,"bankrupt":true}`
```

**Other Players**
```javascript
    statusCode: 200,
    body: `{"round":1,"stage":3,"stageStartTime":"19/06/2024, 16:21:12","stageDuration":20}`
```
