...
```javascript
    statusCode: 200,
    body: `{"round":1,"stage":2,"stageStartTime":"2024-06-19T07:40:16.920Z","stageDuration":20}`
```

#### To Players 
```javascript
    statusCode: 200,
    body: `{"round":1,"stage":2,"stageStartTime":"2024-06-19T07:40:16.920Z","stageDuration":20,"taxRate":0.15}`
```
